...
/* ---------------- Inline SVG icons (with size fallbacks) ---------------- */
const ICON_PATHS = {
  email:
...
function BrandMark() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <g stroke="#c62828" strokeWidth="2" strokeLinecap="round">
        <path d="M24 24 13 12" />
        <path d="m24 24 12-7" />
        <path d="M24 24 11 33" />
        <path d="m24 24 11 12" />
...
/* ================= Navbar ================= */
export default function Navbar({ onNavClick, onSubPage, activePage }) {
  ...
  return (
    <>
      ...
      <header className={`site-header${scrolled ? ' scrolled' : ''}`}>
        ...
        {/* ---- LAYER 1: top info strip (hides on scroll) ---- */}
        ...
        {/* ---- LAYER 2: white logo bar (shrinks on scroll) ---- */}
