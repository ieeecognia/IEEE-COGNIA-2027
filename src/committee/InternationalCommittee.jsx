  ...
  const members = [
    {
      ...
      role: 'Professor',
      dept: 'Computer Networks Engineering',
    ...
    },
    {
      ...
      role: 'Professor',
      dept: '',
      org: 'Broad Institute and the Georgia Institute of Technology',
    },
    {
    ...
    },
    {
      ...
      role: 'Professor',
      dept: '',
      org: 'Big Data and Data Science Unit · Eurecat, Barcelona, Spain',
    },
    {
      name: 'Weiwei Jiang',
      role: 'Professor',
      dept: '',
      org: 'School of Information and Communication Engineering, Beijing University of Posts and Telecommunications',
    },
    {
    ...
    },
    {
      ...
      role: 'Professor',
      dept: '',
      org: 'School of Engineering, Smart Green Cities Research Centre, Macquarie University, Australia',
    },
    {
